...
exec $command -Duser.home=/home/suwayomi -Xmx4g -Xms1024m -XX:+UseG1GC -XX:+UseStringDeduplication -XX:+DisableExplicitGC -Djava.awt.headless=true -Dfile.encoding=UTF-8 -jar "/home/suwayomi/startup/tachidesk_latest.jar";
# exec $command -Duser.home=/home/suwayomi -Xmx2g -Xms512m -Djava.awt.headless=true -Dfile.encoding=UTF-8 -jar "/home/suwayomi/startup/tachidesk_latest.jar";